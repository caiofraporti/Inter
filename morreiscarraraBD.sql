...
(
    venda_codigo    int     not null references vendas,
    item            int     not null,
    produto_codigo  int     not null references produtos,
    qtd             int     not null,
...
-- inserts das tabelas
--==================================================================
INSERT INTO Pessoas (nome, nome_social, tipo_pessoa, documento, tipo_endereco, logradouro, numero, bairro, cidade, cep, telefone, email)
VALUES 
('João Silva', NULL, 'F', '12345678900', 'Residencial', 'Rua A', '100', 'Centro', 'São Paulo', '01000-000', '11999999999', 'joao@email.com'),
('Maria Souza', NULL, 'F', '98765432100', 'Residencial', 'Rua B', '200', 'Zona Sul', 'São Paulo', '02000-000', '11988888888', 'maria@email.com'),
('Empresa XPTO', NULL, 'J', '11222333000100', 'Comercial', 'Av Paulista', '1000', 'Bela Vista', 'São Paulo', '01310-100', '1133334444', 'contato@xpto.com');


INSERT INTO Clientes (pessoa_id)
VALUES (1), (2), (3);

INSERT INTO Fornecedores (pessoa_id)
VALUES (3), (1), (2);

INSERT INTO Funcionarios (pessoa_id, usuario, senha)
VALUES 
(1, 'joao_user', '123456'),
(2, 'maria_user', '123456'),
(3, 'admin', 'admin123');

INSERT INTO Produtos (nome_produto, descricao, valor_unitario)
VALUES 
('Mesa', 'Mesa de madeira', 500.00),
('Cadeira', 'Cadeira estofada', 150.00),
('Sofá', 'Sofá 3 lugares', 1200.00);

INSERT INTO Vendas (data, total, nr_parcelas, cliente_id, funcionario_id)
VALUES 
('2026-03-01', 800.00, 2, 1, 1),
('2026-03-02', 1500.00, 3, 2, 2),
('2026-03-03', 1200.00, 1, 3, 3);

INSERT INTO Compras (data, total, nr_parcelas, fornecedor_id, funcionario_id)
VALUES 
('2026-03-01', 2000.00, 2, 3, 1),
('2026-03-02', 3000.00, 3, 1, 2),
('2026-03-03', 1500.00, 1, 2, 3);
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            PRINT 'Novo ID já está vinculado a outro cliente'
            RETURN 1
        END
...
BEGIN
    ...
    BEGIN CATCH
        ROLLBACK
        PRINT 'Erro ao inserir situação'
        RETURN 1
    END CATCH
END
GO
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            PRINT 'Já existe uma situação com essa descrição'
            RETURN 1
        END
...
BEGIN
    ...
    BEGIN CATCH
        ROLLBACK
        PRINT 'Erro ao inserir lançamento'
        RETURN 1
    END CATCH
END
GO
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            PRINT 'Situação não existe'
            RETURN 1
        END

        IF @pagamento IS NOT NULL AND @pagamento < @vencimento
        BEGIN
            PRINT 'Data de pagamento não pode ser anterior ao vencimento'
            RETURN 1
        END
    ...
    BEGIN CATCH
        ROLLBACK
        PRINT 'Erro ao atualizar lançamento'
        RETURN 1
    END CATCH
END
GO
...
BEGIN
    BEGIN TRY
        ...
        BEGIN
            PRINT 'Item da venda não encontrado'
            RETURN 1
        END
